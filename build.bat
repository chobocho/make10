...
REM Output: release\index.html, release\dist.js, release\data\*.json
...
copy /Y data\*.json release\data\ > nul
if errorlevel 1 goto :fail

echo [build] done (release/ contains index.html + dist.js + data/)
exit /b 0
