...
- [x] #31 연쇄 보너스 — 1초 이내 매치 시 +50/+100/... cap +250 (2026-04-25)
- [x] #32 3셀 매치 점수 400 → 300 재조정 (2026-04-25)
- [x] #33 만능(?) 블럭 — stuck 회복 + 랜덤 타임 자동 스폰 (2026-04-25)
- [x] #34 보너스(×2) 블럭 — 10-12s 간격 스폰 + 2-5s 윈도우 + 무지개 배경 (2026-04-25)
- [x] #35 힌트 보충 — 레벨%8 시 3개 보장 + ★3 클리어 시 다음 판 +1 (2026-04-25)
